...
<body onload="initialize()">
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php" style="color: white;">KOSAN_MS1</a>
      </div>
  ...
  <img src="assets/img/kosan.png" alt="" whidth="1000px" height="1000px">
  ...
  <script type="text/javascript">
    var markerImage = 'assets/img/kost.png';
    var myCurrentLocationMarker = 'assets/img/kost.png';
  </script>
</body>
</html>